...
const siteData = deserializeFunctions(JSON.parse('{"lang":"zh-CN","dir":"ltr","title":"Aoe","description":"开发文档、规范、示例等...","base":"/docs/","head":[],"appearance":true,"themeConfig":{"logo":"/logo.svg","search":{"provider":"local"},"lastUpdatedText":"上次更新","nav":[{"text":"🏡 主页","link":"/"},{"text":"📚 文档","link":"/notes/pnpm-monorepo"},{"text":"🌻 日志","link":"/log/index.md"},{"text":"🌰 示例","link":"/examples/markdown-examples"},{"text":"🕶️ 关于","link":"/about"}],"sidebarMenuLabel":"目录","sidebar":{"/notes/":[{"text":"文档 📚","collapsed":true,"items":[{"text":"🏟️ vue3 略知一二","link":"/notes/vue3-略知一二"},{"text":"⛵️ vite 知多知少","link":"/notes/vite-知多知少"},{"text":"🛟 rem+vw","link":"/notes/rem+vw"},{"text":"🛥️ el-collapse-transition 看一看","link":"/notes/el-collapse-transition"},{"text":"Pnpm and Monorepo","link":"/notes/pnpm-monorepo"}]}],"/examples/":[{"text":"示例 🌰","collapsed":true,"items":[{"text":"Markdown Examples","link":"/examples/markdown-examples"},{"text":"Runtime API Examples","link":"/note/api-examples"}]}],"/log/":[],"/about":[]}},"locales":{},"scrollOffset":90,"cleanUrls":true}'));
